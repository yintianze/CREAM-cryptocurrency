...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    {
        nSubsidy = 30000000 * COIN;   // 30M Premine
    }
        else if(pindexBest->nHeight < 50)
    {
        nSubsidy = 100 * COIN;  // ~5000
    }
        else if(pindexBest->nHeight < 2000)
    {
        nSubsidy = 4000 * COIN;  // ~7800000
    }
        else if(pindexBest->nHeight < 4000)
    {
        nSubsidy = 3000 * COIN;  // ~6000000
    }
        else if(pindexBest->nHeight < 6000)
    {
        nSubsidy = 2000 * COIN;  // ~4000000
    }
		else if(pindexBest->nHeight < 8000)
    {
        nSubsidy = 1000 * COIN;  // ~2000000
    }
		else if(pindexBest->nHeight < 16000)
    {
        nSubsidy = 500 * COIN;  // ~4000000
    }
		else if(pindexBest->nHeight < 32000)
    {
        nSubsidy = 100 * COIN;  // ~1600000
    }
		else if(pindexBest->nHeight < 64000)
    {
        nSubsidy = 50 * COIN;  // ~1600000
    }
		else if(pindexBest->nHeight < 128000)
    {
        nSubsidy = 10 * COIN;  // ~640000
    }
        else
    {
        nSubsidy = 1 * COIN;
...
{
    int64_t ret = blockValue * 0.20; //20% for masternodes
