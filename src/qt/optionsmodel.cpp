...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCreamAmount"))
        settings.setValue("nAnonymizeCreamAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCreamAmount = settings.value("nAnonymizeCreamAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCreamAmount"))
        SoftSetArg("-anonymizeCreamamount", settings.value("nAnonymizeCreamAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCreamAmount:
            nAnonymizeCreamAmount = value.toInt();
            settings.setValue("nAnonymizeCreamAmount", nAnonymizeCreamAmount);
            emit anonymizeCreamAmountChanged(nAnonymizeCreamAmount);
            break;
        default:
            break;
        }
