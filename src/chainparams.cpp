...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Cream Crypto Blockchain - The Beginning 6/17";
        ...
        assert(genesis.hashMerkleRoot == uint256("0xe23220e1a9ce550bda793a0630bf0e80db6e4d0dfccfded48edad7ab2dacbb48"));
